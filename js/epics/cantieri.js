...
import requestBuilder  from '@mapstore/framework/utils/ogc/WFS/RequestBuilder';
import transactionRequestBuilder  from '@mapstore/framework/utils/ogc/WFST/RequestBuilder';
...
import {changeDrawingStatus, END_DRAWING}  from '@mapstore/framework/actions/draw';

import {reprojectGeoJson}  from '@mapstore/framework/utils/CoordinatesUtils';
import {
